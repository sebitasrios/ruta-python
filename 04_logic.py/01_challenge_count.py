...
def check_is_balanced(text):
    ...
    # contar facilmente el numero de veces que aparece la lerta
    count_r = text.count("R")  # Reed Richard
    count_j = text.count("J")  # Jonny Storm

    print(f"count_r: {count_r} count_j: {count_j}")

    # LO QUE NO SE DEBE HACER(se puede simplificar)
    # if count_r == count_j:
    #     return True
    # else:
    #     return False
...
print(check_is_balanced("ASDFSDFOIASDOIFU"))
